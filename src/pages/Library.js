    ...
    return (
        ...
        <Container fluid style={{ textAlign: 'left' }}>
            <Row style={{ padding: '20px' }}>
                ...
                <Col xs={2}><h2>Books</h2></Col>
                <Col xs={6}>
                    
                    <div class="btn-group" >
                        <button id="bt1" onClick={()=>onButton("buy")} value="buy" class="button">Buy</button>
                        <button id="bt2" onClick={()=>onButton("rent")} value="rent" class="button">Rent</button>
                    </div>
                </Col>
                                    ...
                                    <Card >
                                        ...
                                        <Card.Body>
                                            ...
                                            (<div style={{ paddingLeft: "25px" }} >
                                              ...
                                              </div>):(<div style={{ paddingLeft: "25px" }} className="mx-auto">
